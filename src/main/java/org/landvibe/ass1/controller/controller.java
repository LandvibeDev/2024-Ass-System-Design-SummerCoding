...
public class controller {
    ...
    public String getMemberKey(@PathVariable("id") int id) {
        return memberService.get(id);
    }

    @GetMapping("/members/cacheout/{id}")
    public void deleteMemberCache(@PathVariable("id") int id) {
        memberService.deleteMemberCache(id);
    }
